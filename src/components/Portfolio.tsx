...
//                 <span className="text-black text-xl sm:text-2xl md:text-3xl font-medium">
...
//             {/* Project 1 */}
//             <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 shadow-lg hover:shadow-xl transition-shadow duration-300">
...
//                 <span className="bg-yellow-500 text-black px-3 sm:px-4 md:px-5 py-1 sm:py-2 rounded-full text-sm sm:text-base md:text-lg whitespace-nowrap">
//                   UI/UX Design
//                 </span>
//                 <span className="bg-yellow-500 text-black px-3 sm:px-4 md:px-5 py-1 sm:py-2 rounded-full text-sm sm:text-base md:text-lg whitespace-nowrap">
//                   App Design
...
//                   Mobile App Solution
//                 </h3>
//                 <button className="w-10 h-10 sm:w-12 sm:h-12 bg-green-900 rounded-full flex items-center justify-center cursor-pointer hover:bg-green-800 transition-colors duration-300 flex-shrink-0 self-start sm:self-center">
